    ...
    generate({ content, cfg }) {
      ...
      for (const folder of folders) {
        ...
        virtualPages.push({
          slug: slug2,
          title,
          // Marked unlisted so these auto-generated folder pages don't show
          // up as isolated, disconnected nodes in the graph — they're still
          // fully reachable pages, just excluded from the graph/search index.
          data: { unlisted: true }
        });
      }
      return virtualPages;
